...
class PatchSquaredDistanceComponentsTest :
  public levelSet::PatchSquaredDistanceComponents
{
private:
...
public:
  ...
  PatchSquaredDistanceComponentsTest(const float spacing) :
    Base(spacing)
  {
  }
...
main()
{
  typedef PatchSquaredDistanceComponentsTest Patch;
