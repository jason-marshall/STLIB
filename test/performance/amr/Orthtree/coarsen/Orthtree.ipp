...
main(int argc, char* argv[]) {
   ...
   // Make a criterion that returns true.
   ads::UnaryConstant<iterator, bool> criterion;
   criterion.set(true);
   ...
   do {
      ...
      for (int n = 0; n != count; ++n) {
         orthtree = copy;
         coarsenCount += coarsen(&orthtree, criterion);
      }
   ...
   std::cout << elapsedTime / coarsenCount * 1e9 << "\n";
