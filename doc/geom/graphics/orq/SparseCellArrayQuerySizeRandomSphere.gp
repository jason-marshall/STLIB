# SparseCellArrayQuerySizeRandomSphere.gp

set size 0.7,0.7
set key right bottom
set title 'Sparse Cell Array, Random Points on a Sphere'
...
set nomytics
set output 'SparseCellArrayQuerySizeRandomSphereTotal.eps'
plot [0.00138107/1.1:2*1.1]\
  'SparseCellArrayQuerySizeRandomSphere.dat'\
...
set ytics 1,2,2048
set output 'SparseCellArrayQuerySizeRandomSphereScaled.eps'
