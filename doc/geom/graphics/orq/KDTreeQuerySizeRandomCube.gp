# KDTreeQuerySizeRandomCube.gp

set size 0.7,0.7
set key right bottom
set title 'Kd-tree with No Domain Checking, Random Points in a Cube'
...
set nomytics
set output 'KDTreeQuerySizeRandomCubeTotal.eps'
plot [0.00984313/1.1:0.793701*1.1]\
  'KDTreeQuerySizeRandomCube.dat'\
...
set ytics 1,2,512
set output 'KDTreeQuerySizeRandomCubeScaled.eps'
