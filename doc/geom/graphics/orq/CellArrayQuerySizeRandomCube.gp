# CellArrayQuerySizeRandomCube.gp

set size 0.7,0.7
set key right bottom
set title 'Cell Array, Random Points in a Cube'
...
set nomytics
set output 'CellArrayQuerySizeRandomCubeTotal.eps'
plot [0.00984313/1.1:0.793701*1.1]\
  'CellArrayQuerySizeRandomCube.dat'\
...
set ytics 1,2,1024
set output 'CellArrayQuerySizeRandomCubeScaled.eps'
