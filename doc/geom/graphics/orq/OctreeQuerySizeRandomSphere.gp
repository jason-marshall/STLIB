# OctreeQuerySizeRandomSphere.gp

set size 0.7,0.7
set key right bottom
set title 'Octree, Random Points on a Sphere'
...
set nomytics
set output 'OctreeQuerySizeRandomSphereTotal.eps'
plot [0.00138107/1.1:2*1.1]\
  'OctreeQuerySizeRandomSphere.dat'\
...
set ytics 1,2,1024
set output 'OctreeQuerySizeRandomSphereScaled.eps'
