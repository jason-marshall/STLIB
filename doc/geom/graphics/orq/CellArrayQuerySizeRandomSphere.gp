# CellArrayQuerySizeRandomSphere.gp

set size 0.7,0.7
set key right bottom
set title 'Cell Array, Random Points on a Sphere'
...
set nomytics
set output 'CellArrayQuerySizeRandomSphereTotal.eps'
plot [0.00138107/1.1:2*1.1]\
  'CellArrayQuerySizeRandomSphere.dat'\
...
set ytics 1,2,1024
set output 'CellArrayQuerySizeRandomSphereScaled.eps'
