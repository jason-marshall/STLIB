...
#include "stlib/ads/array/ArrayContainer.h"
#include "stlib/ads/array/ArrayIndexing.h"
...
public:
  ...
  */
   ...
   */
  typedef typename boost::mpl::if_c<A || std::is_const<value_type>::value,
...
public:
  ...
  */
  ...
  get(std::istream& in)
  {
    get(in, std::integral_constant<bool, A>());
  }
  ...
  */
  ...
  read(std::istream& in)
  {
    read(in, std::integral_constant<bool, A>());
  }
...
#include "stlib/ads/array/Array.ipp"
#undef __Array_ipp__

#define __Array1_h__
#include "stlib/ads/array/Array1.h"
#undef __Array1_h__
